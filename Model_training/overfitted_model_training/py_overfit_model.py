...
online_em_stepsize =  0.002179259226629478
...
for epoch_count in range(max_num_epochs):
    ...
    # evaluate
    train_ll = EinsumNetwork.eval_loglikelihood_batched_orig(einet, train_x)  ### use the original function
    ...
    val_ll = EinsumNetwork.eval_loglikelihood_batched_orig(einet, val_x)  ## use the original function
