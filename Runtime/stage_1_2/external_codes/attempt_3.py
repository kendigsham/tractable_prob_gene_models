...
def pred(
    ...
    ll_sample = EinsumNetwork.eval_loglikelihood_batched(model, zero_input,batch_size=12000)
    pred_zero = ll_sample
    ...
    for idx in tqdm(range(loader.num_batches)):
        ...
        ll_sample = EinsumNetwork.eval_loglikelihood_batched(model, next(loader),batch_size=12000)
